...
function init() {
    ...
    let markerControl = new THREEx.ArMarkerControls(arToolkitContext, markerRoot1, {
        ...
        type: 'pattern', patternUrl: 'data/pattern-AR.patt',
    });
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('Lat.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('Lat.obj', function (group) {
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('Slow.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('Slow.obj', function (group) {
     ...
     new THREE.MTLLoader()
     .setPath('data/models/')
     .load('Gha.mtl', function (materials) {
         materials.preload();
         new THREE.OBJLoader()
             .setMaterials(materials)
             .setPath('data/models/')
             .load('Gha.obj', function (group) {
     ...
     new THREE.MTLLoader()
     .setPath('data/models/')
     .load('Psy.mtl', function (materials) {
         materials.preload();
         new THREE.OBJLoader()
             .setMaterials(materials)
             .setPath('data/models/')
             .load('Psy.obj', function (group) {
     ...
     new THREE.MTLLoader()
        .setPath('data/models/')
        .load('Umb.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('Umb.obj', function (group) {
